...
import { LendingContractFactory } from '../artifacts/lending_contract/LendingContractClient'
...
describe('LendingContract contract', () => {
  ...
  const deploy = async (account: Address) => {
    const factory = localnet.algorand.client.getTypedAppFactory(LendingContractFactory, {
