...
export type LendingContractComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<LendingContractComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<LendingContractComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<LendingContractComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  /**
